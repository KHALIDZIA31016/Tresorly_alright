...
class AppImages {
  ///Png images
  static const String splashLogo = 'assets/img/splashLogo.png';
  static const String splashBg = 'assets/img/splashBg.png';
  static const String backgroundImg = 'assets/img/bgImage.png';
  static const String simpleBg = 'assets/img/simpleBg.png';
  static const String smallBg = 'assets/img/smallBg.png';
  static const String netflix = 'assets/img/netflix.png';
  static const String copy = 'assets/img/copy.png';
  static const String whiteDot = 'assets/img/whiteDot.png';

  ///Svg images
  static const String googleSvg = 'assets/svgImg/googleSvg.svg';
  static const String appleSvg = 'assets/svgImg/appleSvg.svg';
  static const String faceIDSvg = 'assets/svgImg/faceIDSvg.svg';
  static const String notificationSvg = 'assets/svgImg/notificationSvg.svg';
  static const String menuSvg = 'assets/svgImg/menuSvg.svg';
  static const String browseSvg = 'assets/svgImg/browseSvg.svg';
  static const String mobileAppSvg = 'assets/svgImg/mobileAppSvg.svg';
  static const String paymentSvg = 'assets/svgImg/paymentSvg.svg';
 static const String favRedSvg = 'assets/svgImg/favRedSvg.svg';
  static const String favSvg = 'assets/svgImg/favSvg.svg';
  static const String shareSvg = 'assets/svgImg/shareSvg.svg';
  static const String reuseSvg = 'assets/svgImg/reuseSvg.svg';
  static const String whiteDotSvg = 'assets/svgImg/whiteDotSvg.svg';
  static const String calenderSvg = 'assets/svgImg/calenderSvg.svg';
  ...
  static List<Widget> trailingTile1 = [
    Image.asset(AppImages.copyIcon, height: 22, width: 22),
    const Icon(
      Icons.favorite,
      color: Colors.red,
      size: 20,
  ...
  static Image globeLogo = const Image(
      image: AssetImage(
    'assets/assets_h/icons/globe.png',
  ));
  static Image lockLogo = const Image(
      image: AssetImage(
    'assets/assets_h/icons/lock.png',
  ));
  ...
  static Image splashBackground =
      const Image(image: AssetImage('assets/assets_h/images/splashscreen.png'));
  static Image appLogo = const Image(
    image: AssetImage(
      'assets/assets_h/images/appLogo.png',
    ),
    height: 206,
    width: 206,
  );
  static Image amazonLogo = const Image(
      image: AssetImage(
    'assets/assets_h/images/amazon.png',
  ));
  static Image messengerLogo = const Image(
      image: AssetImage(
    'assets/assets_h/images/messenger.png',
  ));
  static Image gmailLogo = const Image(
      image: AssetImage(
    'assets/assets_h/images/gmail.png',
  ));
  static Image courseraLogo = const Image(
      image: AssetImage(
    'assets/assets_h/images/coursera.png',
  ));
  static Image netflixLogo = const Image(
      image: AssetImage(
    'assets/assets_h/images/netflix.png',
  ));
  static Image udemyLogo = const Image(
      image: AssetImage(
    'assets/assets_h/images/udemy.png',
  ));
  static Image profileLogo = const Image(
    image: AssetImage(
      'assets/prof.png',
    ),
    height: 150,
  ...
  static Image binLogo = const Image(
      image: AssetImage(
    'assets/assets_h/images/bin.png',
  ));
}
